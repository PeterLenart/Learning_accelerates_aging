...
fn main() {
    ...
    let start_improvement_strength = Vec::from([0.0]);
    ...
    for &start_b in start_b_grid.iter(){
        for &start_improvement in start_improvement_grid.iter(){
            ...
            let base_name_part = format!("early_slope_toy_model_step_fertility_varying_start_and_b_{}_{}", initial_lmax_distribution[0], initial_b_distribution[0]);
            let output_file_name = format!("./simulation_results/toy_model_simulations/varying_start_no_improvement_fert_start_5/{}_{}_{}_{}_{}_{}.csv", base_name_part, mating_name_part, learning_name_part, removal_name_part, tradeoff_name_part,learning_parameters[2]);
    ...
    // let start_gmax_grid = linspace(0.0, 0.175, 11);
    ...
    //         let output_file_name = format!("./simulation_results/gla_simulations/gmax_simulations/varying_gmax/{}_{}_{}_{}_{}.csv", base_name_part, mating_name_part, growth_name_part, removal_name_part, tradeoff_name_part);
