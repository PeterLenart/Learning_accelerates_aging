...
use crate::gla_package::{gla::{
    aging_gompertz_makeham, fertility_brass_polynomial, constant_fertility, step_affine_fertility, affine_fertility, gla_model,
...
fn main() -> Result<(), Box<dyn Error>>{
    ...
    // let fertility_parameters = [0.1f64];
    // let fertility_function = constant_fertility;

    // let fertility_parameters = [1f64, 25.0, 100.0];
    // let fertility_function = step_fertility;

    // let fertility_parameters = [-0.0025f64, 0.1];
    // let fertility_function = affine_fertility;

    // let fertility_parameters = [0.005f64, 0.05];
    // let fertility_function = affine_fertility;

    let fertility_parameters = [0.01, 0_f64, 25_f64, f64::INFINITY];
    let fertility_function = step_affine_fertility;

    // let fertility_parameters = [0.01, -0.001, 25_f64, f64::INFINITY];
    // let fertility_function = step_affine_fertility;
    ...
    // Save result
    let output_file_name = "./output/gla_landscapes_lmax/csv/fitness_constant_fertility.csv";
    ...
    // // Save result
    // let output_file_name = "./output/gla_landscapes_lmax/csv/fitness_reduced_b_decreasing_fertility.csv";

    // // Combine the grid and fitness difference into one array
    // let fitness_reduced_b_reshaped = fitness_reduced_b.clone().insert_axis(Axis(1));
    // let combined_data = stack![Axis(1), reduced_b_grid.clone(), fitness_reduced_b_reshaped];
    // // Write to CSV
    // let file = File::create(output_file_name)?;
    // let mut writer = WriterBuilder::new().has_headers(true).from_writer(file);
    // // Write headers
    ...
    // Save result
    let output_file_name = "./output/gla_landscapes_lmax/csv/fitness_difference_constant_fertility.csv";
    ...
    // // Save result
    // let output_file_name = "./output/gla_landscapes_gmax/csv/fitness_increasing_fertility.csv";
    ...
    // // Save result
    // let output_file_name = "./output/gla_landscapes_gmax/csv/fitness_difference_increasing_fertility.csv";
